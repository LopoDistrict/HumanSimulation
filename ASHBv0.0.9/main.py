...
def begin_param():
    ...
    file = ('./data/temp/presence.asb', './data/memory/char_mem.mem',
    ...
    cal_file = ('./calculation_software/cal.so', './calculation_software/rand.cpp',
     ...
     './Data.h', './clock.cpp','./calculation_software/reinforcment_intelligence/model.h', './calculation_software/reinforcment_intelligence/model.cpp',
      './data/logs/logs.txt', './prog_clock.exe', './calculation_software/reinforcment_intelligence/reaction.cpp', 
      './calculation_software/reinforcment_intelligence/reaction.h'
     )
    ...
    try:
        os.remove("./data/temp/tempSeparation.asb")
    except:
        pass
    ...
    file_logs.close()
    main_file_logs = open("./data/logs/main_logs.txt", "w")
    main_file_logs.close()
